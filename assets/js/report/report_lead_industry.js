...
$(function(){
	...
	$('#report_lead_frm').submit(function(e){
		...
		var params = {start_date:start_date,end_date:end_date,stage:stage,customer:customer,worth:worth,owner:owner,leadassignee:leadassignee,regionname:regionname,countryname:countryname,statename:statename,locname:locname,industry:industry};
		params[csrf_token_name]   = csrf_hash_token;
		$('#report_grid').load(base_url+'report/report_lead_industry/get_lead_report',params,function(){
			$('#advance').show();
			$('#load').hide();	
		});
