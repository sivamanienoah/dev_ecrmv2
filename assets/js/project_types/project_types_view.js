...
function checkStatus(id) {
	...
	$.ajax({
		type: "POST",
		url: site_base_url+'project_types/ajax_check_status/',
		dataType:"json",                                                                
		data: formdata,
		cache: false,
		beforeSend:function(){
		...
		success: function(response) {
			if (response.html == 'NO') {
				...
				$('#dialog-message-'+id).append("One or more Projects currently assigned for this Project types. This cannot be deleted.");
...
function processDelete(id) {
	window.location.href = site_base_url+'project_types/delete_project_type/update/'+id;
}
