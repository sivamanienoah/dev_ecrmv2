...
function checkStatus(id) {
	...
	$.ajax({
		type: "POST",
		url: site_base_url+'profit_center/ajax_check_status/',
		dataType:"json",                                                                
		data: formdata,
		cache: false,
		beforeSend:function(){
		...
		success: function(response) {
			if (response.html == 'NO') {
				...
				$('#dialog-message-'+id).append("One or more Projects currently assigned for this cost center. This cannot be deleted.");
...
function processDelete(id) {
	window.location.href = site_base_url+'profit_center/delete_profit_center/update/'+id;
}
