...
function checkStatus(id) {
	...
	$.ajax({
		type: "POST",
		url: site_base_url+'manage_industry/ajax_check_status/',
		dataType:"json",                                                                
		data: formdata,
		cache: false,
		beforeSend:function(){
		...
		success: function(response) {
			if (response.html == 'NO') {
				...
				$('#dialog-message-'+id).append("One or more Leads/Projects currently assigned for this Industry. This cannot be deleted.");
...
function processDelete(id) {
	window.location.href = site_base_url+'manage_industry/delete_industry/update/'+id;
}
