...
$("#search_advance").click(function () {
    ...
    $.ajax({
        type: "POST",
        url: site_base_url + "asset_register/advance_filter_search/search",
        cache: false,
        data: "&stage=" + stage + "&from_date=" + from_date + "&to_date=" + to_date + "&customer=" + customer + "&service=" + service + "&lead_src=" + lead_src + "&industry=" + industry + "&worth=" + worth + "&owner=" + owner + "&leadassignee=" + leadassignee + "&regionname=" + regionname + "&countryname=" + countryname + "&statename=" + statename + "&locname=" + locname + "&lead_status=" + lead_status + "&lead_indi=" + lead_indi + "&keyword=" + keyword + '&' + csrf_token_name + '=' + csrf_hash_token,
...
function show_search_results(search_id) {
    ...
    $.ajax({
        type: "POST",
        url: site_base_url + "asset_register/advance_filter_search/search/" + search_id,
        cache: false,
...
function delete_save_search(search_id) {
    $.ajax({
        type: "POST",
        dataType: 'json',
        url: site_base_url + "asset_register/delete_save_search/" + search_id + '/1',
        cache: false,
...
$("#save_advance").click(function () {
    $.ajax({
        type: "POST",
        dataType: 'json',
        url: site_base_url + "asset_register/get_search_name_form",
        cache: false,
        data: csrf_token_name + '=' + csrf_hash_token,
...
function save_search() {
    ...
    $.ajax({
        type: "POST",
        dataType: 'json',
        url: site_base_url + "asset_register/save_search/1",
        cache: false,
...
$(function () {
    ...
    $('.search-root').on('click', '.set_default_search', function () {
        ...
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: site_base_url + "asset_register/set_default_search/" + search_id + '/1',
            cache: false,
            data: csrf_token_name + '=' + csrf_hash_token,
            beforeSend: function () {
                $('.search-root').block({
...
$('#excel_lead').click(function () {
    ...
    var url = site_base_url + "asset_register/excelExport/";
