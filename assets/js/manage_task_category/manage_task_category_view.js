/*
 *@Manage industry View
 *@Manage industry Controller
*/
...
function checkStatus(id) {
	...
	$.ajax({
		type: "POST",
		url: site_base_url+'manage_task_category/ajax_check_status/',
		dataType:"json",                                                                
		data: formdata,
		cache: false,
		beforeSend:function(){
		...
		success: function(response) {
			if (response.html == 'NO') {
				...
				$('#dialog-message-'+id).append("One or more Tasks currently assigned for this Category. This cannot be deleted.");
...
function processDelete(id) {
	window.location.href = site_base_url+'manage_task_category/delete_task_category/update/'+id;
}
