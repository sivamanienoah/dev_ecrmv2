...
<div id="content">
		...
		if ( isset($pdf) ) {
			...
			$pdf->image("<?php echo  dirname(FCPATH) ?>/assets/pdf/subs/subs-head.jpg", "jpg", 0, 0, 594, 126);
			$pdf->image("<?php echo  dirname(FCPATH) ?>/assets/pdf/subs/subs-bottom.jpg", "jpg", 0, 640, 594, 200);
			$pdf->image("<?php echo  dirname(FCPATH) ?>/assets/pdf/subs/bg-liquid-payments.gif", "gif", 0, 529, 594, 111);
			...
			$color = Style::munge_colour('#00ADEF');
