...
<div id="content">
		...
		if ( isset($pdf) ) {
			...
			$pdf->image("<?php echo  dirname(FCPATH) ?>/assets/pdf/real/real-head.jpg", "jpg", 0, 0, 594, 126);
			$pdf->image("<?php echo  dirname(FCPATH) ?>/assets/pdf/real/real-bottom.jpg", "jpg", 0, 640, 594, 200);
			$pdf->image("<?php echo  dirname(FCPATH) ?>/assets/pdf/real/bg-liquid-payments.gif", "gif", 0, 529, 594, 111);
