	...
	<div id="jv-tab-8-5">
		<?php   
			$checkValue = true;
			 ...
			 <div><form target="_blank" method="post" name="form_set_project" action="<?php echo $this->config->item('support_url').'set_project.php';?>"><input type="hidden" name="project_id" value="<?php echo $AllPjtIds_summary;?>" /> <input type="submit" name="submit" value="View Summary in Mantis" /></form></div>
