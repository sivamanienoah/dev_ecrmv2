						...
						<table cellpadding="0" cellspacing="0" class="data-table leadAdvancedfiltertbl" >
							...
							<tr>	
								...
								<td class="by-exclusion">
									<?php $leaveChecked ='checked="checked"'; if($exclude_leave==0) { $leaveChecked =''; } echo "asdf123".$exclude_leave; ?>
									<label><input type="checkbox" id="exclude_leave" name="exclude_leave" <?php echo $leaveChecked; ?> value="1" /><span>Leave</span></label>
																		
									<br />
									<?php $holidayChecked ='checked="checked"'; if($exclude_holiday==0) { $holidayChecked =''; } ?>
