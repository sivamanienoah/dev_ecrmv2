...
$perc_tot_hr = $perc_tot_cost = $calc_tot_hour = $calc_tot_cost = 0;
	...
	echo "<table class='it_cost_sub_grid'><tr>
			<td style='width:25px;' align='right' class=''><span><b>Total:</b></span></td>
			<td style='width:25px;' align='right' class='rt-ali'><span>".round($tot_hour, 1)."</span></td>
			<td style='width:5px;' align='right' class='rt-ali'><span>".round($tot_cost, 2)."</span></td>
		</tr></table>";
?>
</div>
</div>
