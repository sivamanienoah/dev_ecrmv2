	...
	<div class="inner">
		...
		<tbody>
			<?php if (is_array($customers) && count($customers) > 0) { ?>
				...
				<tr>
					<td><?php if ($this->session->userdata('editAdmin')==1) {?><a class="editConty clrmarron" href="regionsettings/country/update/<?php echo  $customer['countryid'] ?>"><?php echo  $customer['country_name'] ; ?></a><?php } else { echo $customer['country_name']; } ?></td>
