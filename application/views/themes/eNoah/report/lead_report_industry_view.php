...
if($num>0)
{
	...
	{				
			...
			if(empty($res[$res_cnt]->industry) || $res[$res_cnt]->industry != $lead->industry)
			{
				$gross+=$amount;
				...
				createTable($content, $lead->industry);
				$content='';
			}
	}	
...
<script type="text/javascript" src="assets/js/report/lead_report_industry_view.js"></script>