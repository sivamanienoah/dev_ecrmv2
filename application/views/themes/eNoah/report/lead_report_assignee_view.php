...
if($num>0)
{
	...
	{				
			...
			if(empty($res[$res_cnt]->assigned_id) || $res[$res_cnt]->assigned_id != $lead->assigned_id)
			{
				$gross+=$amount;
				...
				createTable($content,$lead->assigned_first_name.' '.$lead->assigned_last_name);
...
<script type="text/javascript" src="assets/js/report/lead_report_assignee_view.js"></script>