		...
		<?php if($this->session->userdata('accesspage')==1) { ?>
	    	...
	    	<form name = 'report_lead_frm' id = 'report_lead_frm' action="<?php echo  $this->uri->uri_string() ?>" method="post" >
				...
				<div class="page-title-head">
					<h2 class="pull-left borderBtm">Leads Report By Industry</h2>
				...
				<table cellpadding="0" cellspacing="0" class="data-table" >
					...
					<tr>
						...
						<td>
							<select  style="width:120px;" multiple="multiple" id="industry" name="industry[]">
...
<script type="text/javascript" src="assets/js/report/report_lead_industry.js"></script>
