...
$(function(){
	...
	$('#report_lead_frm').submit(function(e){
		...
		$('#report_grid').load(base_url+'report/report_lead_region/get_lead_report',{start_date:start_date,end_date:end_date,stage:stage,customer:customer,worth:worth,owner:owner,leadassignee:leadassignee,regionname:regionname,countryname:countryname,statename:statename,locname:locname, '<?php echo $this->security->get_csrf_token_name(); ?>':'<?php echo $this->security->get_csrf_hash(); ?>'},function(){
			$('#advance').show();
			$('#load').hide();	
		});
