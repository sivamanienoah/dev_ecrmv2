...
//! @desc The header is printed in every page.
	//$this->Image('image path',x-pos,y-pos,width,height);
	//$this->Image('http://192.168.0.235:85/vcslocaldev/enoah/app/controllers/html2pdf/cm_logo.jpg',163,8,40,12);
	$this->Image(base_url().'enoah/app/controllers/html2pdf/cm_logo.jpg',163,8,40,12);
...
//! @desc The footer is printed in every page!
	...
	//$this->Image('http://192.168.0.235:85/vcslocaldev/enoah/app/controllers/html2pdf/ftbg.jpg',10,250,610,220); 
	//$this->Cell(165,10,'Copyrights © 2013. All Rights Reserved enoahisolution.com.');
	$this->Cell(165,10, 'Copyrights © '. $cur_year .' All Rights Reserved enoahisolution.com.');
    $this->Cell(35,10,'page '.$this->PageNo(),0,0,'C');
    ...
    case 'ADDRESS': 
      ...
      while (isset($this->cell[$this->row][$this->col])) $this->col++;
  		...
  		if ($this->table['nc'] < $this->col+1) $this->table['nc'] = $this->col+1;
			...
			if (!empty($properties)) $this->cell[$this->row][$this->col]['style'] = $this->setCSS($properties); //name(id/class/style) found in the CSS array!
			$cs = $rs = 1;
