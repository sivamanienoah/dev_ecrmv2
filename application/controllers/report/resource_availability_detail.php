...
set_time_limit(0);
class Resource_availability_detail extends crm_controller {
	function Resource_availability_detail()
	{
		parent::__construct();
	...
	function index(){
		...
		$dept = array();
		$master = array();
		$data['page_heading'] = "Resource Availability - Detail";		
		...
		$this->load->view("resource_availability_detail",$data);
	}
