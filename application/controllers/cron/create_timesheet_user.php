...
class Create_timesheet_user extends crm_controller 
{
	...
	public function index() {
		...
		$time_sheet_users_sql = "SELECT * FROM ".$timesheet_db->dbprefix('user')." WHERE `authentication`='ldb' AND `status` = 'ACTIVE'";
	
		$time_sheet_query  = $timesheet_db->query($time_sheet_users_sql);
