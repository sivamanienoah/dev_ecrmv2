...
{	
	...
	*/
	...
	public function index() 
	{
		...
		$res = $this->db->get_where($this->cfg['dbpref']."leads",array("pjt_id !=" => '',"practice !=" => '', "practice !=" => 6, "practice =" => 12, "pjt_id =" => 'ITS-ULT-04-0916')); //for temporary use
		...
		if(!empty($practice_array)){
			...
			foreach($practice_array as $parr){
				...
				foreach($this->fiscal_month_arr as $fis_mon) {
					...
					$overall_revenue += isset($projects['trend_pract_arr']['trend_pract_val_arr'][$parr][$fis_mon]) ? $projects['trend_pract_arr']['trend_pract_val_arr'][$parr][$fis_mon] : 0;
					$mon_contrib += isset($projects['contribution_trend_arr'][$parr][$fis_mon]) ? $projects['contribution_trend_arr'][$parr][$fis_mon] : 0;
					$overall_contrib += isset($projects['contribution_trend_arr'][$parr][$fis_mon]) ? $projects['contribution_trend_arr'][$parr][$fis_mon] : 0;
