...
class Project_utilization_cost extends crm_controller 
{
	...
	*/
	function index()
	{
		...
		if($this->input->post("filter")!="") {
			$this->load->view('projects/project-utiliz-rpt/utilization-cost-rpt-grid', $data);
		} else {
			$this->load->view('projects/project-utiliz-rpt/utilization-cost-rpt', $data);
		}
	}
