...
$db['econnect']['username'] = 'dev_econnectv11';
$db['econnect']['password'] = 'eCoUn3c#11';
$db['econnect']['database'] = 'dev_econnectv11';
// $db['econnect']['username'] = 'root';
// $db['econnect']['password'] = '';
// $db['econnect']['database'] = 'dev_econnectv11';
$db['econnect']['dbdriver'] = 'mysqli';
...
$db['timesheet']['username'] = 'uat_timesheetv71';
$db['timesheet']['password'] = 'UatT@1122';
